...
namespace Konscious.Security.Cryptography
{
    ...
    public class Argon2CoreTests
    {
        ...
        [Fact]
        public async Task InitializeLanes_BuildsInitialLanesCorrectly()
        {
            var subject = new Argon2iCore(128);
            ...
            var actual = await subject.InitializeLanes(Encoding.UTF8.GetBytes("P@ssw0rd!$")).ConfigureAwait(true);
        ...
        [Fact]
        public async Task Hash_HashesAnArgon2dThingWithSalt()
        {
            ...
            var actual = await subject.Hash(Encoding.UTF8.GetBytes("P@ssw0rd!$"), CancellationToken.None).ConfigureAwait(true);
            Assert.Equal(expected, actual);
        }

        [Fact]
        public async Task Hash_HashesAnArgon2iThingWithSalt()
        {
            var subject = new Argon2iCore(128);
