namespace Konscious.Security.Cryptography
{
    ...
    public class Argon2Tests
    {
        ...
        [Fact]
        public void TestArgon2iWithAwkwardSize()
        {
            var expected = new byte[] {
        ...
        [Fact]
        public void TestArgon2idWithAwkwardSize()
        {
            var expected = new byte[]
            {
                0xb0, 0x63, 0x8a, 0xf9, 0xdb, 0x0c, 0x53, 0xee, 0xeb, 0xfc, 0x19, 0xaf,
                0xec, 0xf2, 0x1e, 0x2f, 0x56, 0xf8, 0x1a, 0x93, 0x8e, 0x52, 0xfb, 0xfa,
                0xef, 0x28, 0xe7, 0x39, 0xa2, 0xda, 0xb3, 0x04, 0x4b, 0xae, 0x3c, 0x15,
                0x86, 0xf8, 0xd4, 0xf9, 0x87, 0xae, 0xb1, 0x35, 0xb5, 0x4d, 0x13, 0xab,
                0x6c, 0x07, 0x5b, 0x6e, 0xe7, 0x99, 0xb8, 0xdd, 0xa5, 0x1c, 0x0a, 0x06,
                0xa4, 0x96, 0x55, 0x00, 0xe4, 0x39, 0x47, 0xc6, 0x50, 0x53, 0x2b, 0xe0,
                0x4d, 0x45, 0xa6, 0xc5, 0x13, 0x25, 0xda, 0xe6, 0x9b, 0xec, 0x8b, 0xa9,
                0xf5, 0x3f, 0x16, 0x7b, 0xa1, 0x6f, 0xa3, 0xc9, 0xc9, 0xa5, 0x9c, 0x2a,
                0x18, 0x04, 0x9a, 0xba, 0x70, 0xf4, 0x35, 0x18, 0x1d, 0x34, 0x5f, 0xb4,
                0xb3, 0x13, 0x33, 0xfe, 0x92, 0x93, 0x51, 0xa9, 0x26
            };
        ...
        [Fact]
        public void TestArgon2iWithShortAwkwardSize()
        {
            var expected = new byte[] {
        ...
        [Fact]
        public void TestArgon2idWithShortAwkwardSize()
        {
            var expected = new byte[]
            {
                0x7b, 0x86, 0xa6, 0xf4, 0x51, 0xab, 0x39, 0x43, 0x38, 0x17, 0x14, 0x6a, 0xc8, 0xd6, 0x81, 0x09,
                0x68, 0x83, 0x4d, 0x01, 0x11, 0xb8, 0x95, 0x3a, 0xe9, 0xb6, 0x65, 0x6b, 0x4d, 0xad, 0x3c, 0xda,
                0xc9, 0xd0, 0x85, 0xd7, 0x88, 0xd1, 0xe9, 0xb6, 0x93, 0x46, 0xe4, 0x80, 0x11, 0x77, 0x5d
            };

            var subject = new Argon2id(Encoding.UTF8.GetBytes("#S3cr3t+Ke4$"));
            subject.DegreeOfParallelism = 5;
            subject.Iterations = 7;
            subject.MemorySize = 1024;
            subject.Salt = _salt;
